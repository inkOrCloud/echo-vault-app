...
void main() {
  testWidgets('displays song info', (tester) async {
    await tester.pumpWidget(MaterialApp(home: Scaffold(body: SongListTile(
      song: Song(id: '1', title: 'Bohemian Rhapsody', artist: 'Queen', album: 'A Night at the Opera', durationMs: 354000, fileStatus: FileStatus.fileStatusUploaded),
    ))));
  ...
  testWidgets('formats duration correctly', (tester) async {
    await tester.pumpWidget(MaterialApp(home: Scaffold(body: SongListTile(
      song: Song(id: '1', title: 'T', durationMs: 245000, fileStatus: FileStatus.fileStatusUploaded),
    ))));
